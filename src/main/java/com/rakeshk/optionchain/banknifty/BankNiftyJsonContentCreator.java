...
public class BankNiftyJsonContentCreator extends JsonContentCreator{
	...
	private List<Datum> createData(Filtered filtered, int minRange, int maxRange) {
    	...
    	for (com.rakeshk.optionchain.banknifty.model.Datum externalDatum :  filtered.data) {
